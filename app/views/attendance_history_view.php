                ...
                <tbody>
                    ...
                    <?php else: foreach ($records as $row): ?>
                        <tr>
                            ...
                            <td><?= !empty($row['am_in']) ? date('h:i A', strtotime($row['am_in'])) : (!empty($row['time_in']) ? date('h:i A', strtotime($row['time_in'])) : '---') ?></td>

                            <td><?= !empty($row['pm_out']) ? date('h:i A', strtotime($row['pm_out'])) : (!empty($row['time_out']) ? date('h:i A', strtotime($row['time_out'])) : '---') ?></td>
                            <td>
