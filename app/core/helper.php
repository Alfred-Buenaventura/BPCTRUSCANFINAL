...
class Helper {
    ...
    public static function isScheduleAdmin() {
        return isset($_SESSION['role']) && $_SESSION['role'] === 'Schedule Admin';
    }

    public static function anyAdmin() {
        return self::isAdmin() || self::isScheduleAdmin();
    }
